    ...
    public partial class MainWindow : System.Windows.Window
    {
        ...
        private void _TireListBox_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            if (tireListBox.SelectedItems.Count == 1)
            {
                ...
                tireModelComboBox.Text = tire.TireModel.ID;
            }
        }
        ...
        private void _TireModelListBox_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            if (tireModelListBox.SelectedItems.Count == 1)
            {
                ...
                tireModelMinSlipAngleTextBox.Text = (tireModel.AlphaMin * 180 / Math.PI).ToString("F3");
                tireModelMaxSlipAngleTextBox.Text = (tireModel.AlphaMax * 180 / Math.PI).ToString("F3");
                tireModelMinLongitudinalSlipTextBox.Text = tireModel.KappaMin.ToString("F3");
                tireModelMaxLongitudinalSlipTextBox.Text = tireModel.KappaMax.ToString("F3");
        ...
        private void _GenerateOneWheelPowerTrainDiagram()
        {
            ...
            DockingManager.SetDesiredWidthInDockedMode(oneWheelCarAndSetupDockingWindow, 500 + oneWheelCarAndSetupDockingWindow.ActualHeight);
        }
        /// <summary>
        ...
        private void _GenerateTwoWheelPowerTrainDiagram()
        {
            ...
            DockingManager.SetDesiredWidthInDockedMode(twoWheelCarAndSetupDockingWindow, 500 + twoWheelCarAndSetupDockingWindow.ActualHeight);
        }
        ...
        {
            if ((ggvDiagramIDTextBox.Text != "" || (bool)simulationGGVDiagramUseCarAndSetupIDCheckBox.IsChecked) &&
                ...
                Math.Abs(double.Parse(ggvDiagramLowestSpeedTextBox.Text)) <= Math.Abs(double.Parse(ggvDiagramHighestSpeedTextBox.Text)))
            {
                ...
                switch (ggvDiagramVehicleTypeSelectionComboBox.SelectedValue.ToString())
                {
                    case "One Wheel":
                        ...
                        // Corrects the id if the checkbox is selected
                        if ((bool)simulationGGVDiagramUseCarAndSetupIDCheckBox.IsChecked) id = oneWheelCar.ToString();
                    ...
                    case "Two Wheel":
                        ...
                        // Corrects the id if the checkbox is selected
                        if ((bool)simulationGGVDiagramUseCarAndSetupIDCheckBox.IsChecked) id = twoWheelCar.ToString();
                        progressBarWindow.taskID.Text = "Generating GGV Diagram. ID: " + id;
                        // Initializes and generates the GGV diagram
        ...
        private void _SimulationGGVDiagramListBox_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            ...
            if (simulationGGVDiagramListBox.SelectedItems.Count == 1)
            {
                ...
                if ((bool)simulationGGVDiagramAllowDisplayCheckBox.IsChecked) _UpdateSimulationGGVDiagramDisplayChart();
            }
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void _SimulationGGVDiagramAllowDisplayCheckBox_Checked(object sender, RoutedEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void _SimulationGGVDiagramAllowDisplayCheckBox_Unchecked(object sender, RoutedEventArgs e)
        {
        ...
        private void _UpdateSimulationGGVDiagramDisplayChart()
        {
            ...
            DockingManager.SetDesiredWidthInDockedMode(ggvDiagramDefinitionDockingWindow, 500 + ggvDiagramDefinitionDockingWindow.ActualHeight);
        }
        ...
        {
            if ((lapTimeSimulationIDTextBox.Text != "" || (bool)lapTimeSimulationUsePathAndGGVDiagramIDsCheckBox.IsChecked) &&
                ...
                lapTimeSimulationGGVDiagramComboBox.SelectedItem != null)
            {
                ...
                // Corrects the ID if the checkbox is selected
                if((bool)lapTimeSimulationUsePathAndGGVDiagramIDsCheckBox.IsChecked) id = "Path: " + path.ToString() + " - GGV: " + ggvDiagram.ToString();
